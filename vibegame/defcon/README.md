...
一款 3D 球面核战策略游戏，**竖屏移动端单手游玩**。六个虚构阵营在一颗星球上互相威慑，你通过一次次危机抉择把世界推向——或拉离——核战争边缘。核弹有限、死得少的才算赢。
...
终局按「剩余存活人口」排名。赢不是灭了对手，是活下来的人多。

顶栏「≡」打开抽屉：各方存活人口、单位图例（六边形 = 发射井，三角 = 防空，椭圆 = 雷达）与全部城市列表。敌方单位默认不可见，只有被雷达捕获并弹道溯源标记后才会显形。

## 三条设计主线

1. **DEFCON 等级由博弈驱动，不由倒计时驱动** —— 何时开战是六方共同选择的结果
2. **核弹有限且不可逆** —— 打一枚少一枚，先手倾泻会暴露发射井，第二轮就没得打了
3. **剩余人口计分** —— 相互确保毁灭的数学化，逼出二次核反击的考量
