...
Q = {
    ...
    "loco-17": {"must": ["crh380a", "crh380"], "q": ["CRH380A high speed train", "CRH380A EMU China"]},
    "loco-18": {"must": ["cr400af", "cr400"], "q": ["CR400AF Fuxing high speed train", "CR400AF EMU China"]},
    "loco-19": {"must": ["cr200j"], "q": ["CR200J EMU China Railway", "CR200J train"]},
    "loco-20": {"must": ["maglev", "transrapid"], "q": ["Shanghai maglev train Transrapid", "Shanghai maglev demonstration line train"]},
    # 客车
