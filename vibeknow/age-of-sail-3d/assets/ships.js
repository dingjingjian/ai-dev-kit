...
var SHIPS=[
  ...
  {name:'日本桨船（关船）',cls:'small',country:'日本',yard:'因岛',lat:34.28,lon:133.17,family:'eastasia',year:'1550',color:'#8a7a5a',img:'./assets/ships/sekibune.webp',
  ...
  {name:'安宅船',cls:'medium',country:'日本',yard:'堺',lat:34.58,lon:135.48,family:'eastasia',year:'1575',color:'#6a7a5a',img:'./assets/ships/atakebune.webp',
    ...
    stats:[2, 3, 2, 4, 2, 4],tons:450},
  {name:'铁甲船',cls:'large',country:'日本',yard:'大凑',lat:34.49,lon:136.78,family:'eastasia',year:'1578',color:'#4a5a6a',img:'./assets/ships/ironclad.webp',
    intro:'织田信长为破毛利水军，命九鬼嘉隆在伊势大凑造的大安宅船：船身外覆铁板、船楼架大筒，居高临下压制敌船，1578 年第二次木津川口海战取胜。',
    traits:['外覆铁板','船楼大筒','火器压制'],tags:['铁甲','水军','日本'],
    stats:[2, 4, 2, 5, 2, 5],tons:900},
  {name:'龟甲船',cls:'medium',country:'朝鲜',yard:'丽水',lat:34.74,lon:127.74,family:'eastasia',year:'1592',color:'#3a5a7a',img:'./assets/ships/turtle-ship.webp',
    intro:'朝鲜水军将领李舜臣的战船：甲板覆木板顶盖、遍插铁尖刺，龟首可喷烟，舷侧开炮孔。四面受敌亦无法登船，壬辰倭乱中的海战利器。',
    traits:['龟背顶盖','木顶铁刺','舷侧炮孔'],tags:['战船','朝鲜','李舜臣'],
